...
namespace DongYang.View.Products
{
    public partial class frmProducts : XtraForm
    {
        ...
        private void Search()
        {
            ...
            dgvDuLieu.DataSource = _productRepository.GetAll().OrderBy(_ => _.PartNumber);
            Control();
        }
        ...
        {
            frmProductsAddEdit frm = new frmProductsAddEdit();
            frm.ShowDialog();
            Search();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                frmProductsAddEdit frm = new frmProductsAddEdit(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
